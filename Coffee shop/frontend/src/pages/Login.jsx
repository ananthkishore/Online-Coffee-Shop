    ...
    <div className="min-h-[85vh] flex items-center justify-center px-4 py-12 bg-gradient-to-tr from-coffee-950 via-coffee-900 to-coffee-950 text-coffee-100">
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-extrabold font-sans tracking-tight">Welcome Back</h2>
          <p className="text-sm text-coffee-400 mt-1.5">Sign in to order your fresh roast brew</p>
        </div>
        ...
        <div className="glass-panel-dark p-8 rounded-2xl shadow-xl border border-coffee-900/60">
          ...
          <div className="mt-8 text-center text-xs">
            <span className="text-coffee-500">Don't have an account? </span>
            <Link to="/register" className="font-bold text-coffee-400 hover:underline">
              Create an account
            </Link>
          </div>
